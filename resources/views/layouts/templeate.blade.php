    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4 bg-navy">
            ...
            <a href="{{ URL::to('home') }}" class="brand-link">
                <img src="{{ asset('assets/adminlte/dist/img/AdminLTELogo.png') }}" alt="System Notes Logo"
            ...
            <div class="sidebar" style="font-size:15px;">
                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item has-treeview">
                            <a href="#" class="nav-link bg-blue">
                                <i class="nav-icon fa fa-th fa-lg" aria-hidden="true"></i>
                                <p class="text-white">
                                    Dashboard
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        data-accordion="false">
                        <li class="nav-item has-treeview nav-active">
                            <a href="{{ URL::to('/courses') }}" class="text-white nav-link">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        data-accordion="false">
                        <li class="nav-item has-treeview">
                            <a href="/subjects" class="text-white nav-link">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        data-accordion="false">
                        <li class="nav-item has-treeview">
                            <a href="/personnel" class="text-white nav-link">
                ...
                {{-- <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        data-accordion="false">
                        <li class="nav-item has-treeview">
                            <a href="/register_notes" class="text-white nav-link">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        data-accordion="false">
                        <li class="nav-item has-treeview">
                            <a href="/catedra" class="text-white nav-link">
